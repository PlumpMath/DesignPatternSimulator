...
{
    internal class OthellRogue : PersonnageFighterAbstrait
    {
        public OthellRogue(String unNom)
            : base(unNom)
        {
            Nom = unNom;
            HP = 4000;
            ...
            base.CoupDaguePuissance = 3000;
            base.CoupDualPuissance = 500;
            base.CoupEpeePuissance = 500;

            TousLesPersonnages.Add(this);
            Console.WriteLine("Bienvenue {0}", Nom);
        }
        ...
        public override void Attaque_CoupDague(PersonnageAbstrait unPersonnage)
        {
            if (HP > 0)
            {
                ...
                {
                    unPersonnage.HP -= CoupDaguePuissance + PAtk;
                    if (unPersonnage.HP < 0)
                        unPersonnage.HP = 0;
                    Console.WriteLine("{0} donne un coup de dague à {1}: {2} de dégâts", Nom, unPersonnage.Nom, CoupArcPuissance + PAtk);
