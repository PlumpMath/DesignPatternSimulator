...
namespace DesignPatternSimulator
{
    ...
    //        FabriqueFeohWizard fabriqueFeoh = new FabriqueFeohWizard();
    ...
    //        PersonnageAbstrait feoh1;
    //        PersonnageAbstrait yul1;
    ...
    //        feoh1 = fabriqueFeoh.CreerPersonnage("Feoh 1");
    //        yul1 = fabriqueArcher.CreerPersonnage("Yul 1");
    ...
    //            sigel1.AfficherProfil();
    //            Console.WriteLine("----------------healer2 heal sigel1 to max-----------------");
    //            for(int i = 0; i < 5 ; i++)
    //                healer2.Soigner(sigel1);
    //            sigel1.AfficherProfil();
    //            Console.WriteLine("----------------Zariche healer2-----------------");
    //            healer2.EquiperArme(EnumArme.Zariche);
    //            healer2.AfficherProfil();
    //            Console.WriteLine("----------------Zariche hit sigel 1-----------------");
    //            healer2.Attaquer(sigel1);
    //            healer2.AttaqueMagique(sigel1);
    //            sigel1.EquiperArme(EnumArme.Arc);
    //            sigel1.Attaque_TirerFleche(healer2);
    //            yul1.EquiperArmure(EnumArmure.ArmureLegere);
    //            yul1.EquiperArme(EnumArme.Arc);
    //            yul1.EquiperBijou(EnumBijou.Collier);
    //            yul1.Attaque_TirerFleche(sigel1);
    //            yul1.Attaque_TirerFleche(sigel1);
    //            yul1.Attaque_TirerFleche(healer2);
    //        }
    //        catch (Exception ex)
    //        {
